...
//private ProgressBar progressBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Click = (TextView)findViewById(R.id.slg_click);
               ...
               mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                   ...
                   public void onComplete(@NonNull Task<AuthResult> task) {
                       if (task.isSuccessful()) {
                           Toast.makeText(LgStudent.this, "Logged in Successfully", Toast.LENGTH_SHORT).show();
                           startActivity(new Intent(getApplicationContext(), ScheduleStudent.class));
                       } else {
                           Toast.makeText(LgStudent.this, "Error ! " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
